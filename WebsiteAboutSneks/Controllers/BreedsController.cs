...
namespace WebsiteAboutSneks.Controllers
{
    public class BreedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BreedID,BreedDescription")] Breed breed)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BreedID,BreedDescription")] Breed breed)
        {
            if (ModelState.IsValid)
            {
