...
namespace WebsiteAboutSneks.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AnswerID,QuestionID,AnswerText")] Answers answers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AnswerID,QuestionID,AnswerText")] Answers answers)
        {
            if (ModelState.IsValid)
            {
